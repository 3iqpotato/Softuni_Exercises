...
hummus_and_avocado_sandwich = Starter("Hummus and Avocado Sandwich", 7.90, 5)
tortilla_with_beef_and_pork = MainDish("Tortilla with Beef and Pork", 12.50, 5)
risotto_with_wild_mushrooms = MainDish("Risotto with Wild Mushrooms", 15, 5)
chocolate_cake_with_mascarpone = Dessert("Chocolate Cake with Mascarpone", 4.60, 5)
chocolate_and_violets = Dessert("Chocolate and Violets", 5.20, 5)
