class Profile:
    ...
    def password(self, value):
        is_enough_long = len(value) > 7
        has_digit = [a for a in value if a.isdigit()]
        has_upper_letter = [a for a in value if a.isupper()]

        if is_enough_long and has_digit and has_upper_letter:
